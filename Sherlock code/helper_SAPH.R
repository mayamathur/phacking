...
get_optimx_dataframe = function( .yi,
  ...
  if ( length( l$p1[ l$convcode == 0 ] ) > 0 ){
    ...
    # #bm DEBUG: NEED TO HANDLE THIS CASE:
    lc = structure(list(p1 = numeric(0), p2 = numeric(0), value = numeric(0),
                        fevals = numeric(0), gevals = numeric(0), niter = numeric(0),
                        convcode = numeric(0), kkt1 = logical(0), kkt2 = logical(0),
                        xtime = numeric(0), opt.method = character(0)), details = structure(logical(0), .Dim = c(0L,
                                                                                                                 5L), .Dimnames = list(NULL, c("method", "ngatend", "nhatend",
                                                                                                                                               "hev", "message"))), maximize = FALSE, npar = 2L, follow.on = FALSE, row.names = character(0), class = c("optimx",
                                                                                                                                                                                                                                                        "data.frame"))

    l = structure(list(p1 = c(0.147613472521557, 0.149062467501962, 0.148639628062786,
                              0.148534196882656, 0.14761984844834, 0.147612865871993, 0.147612861580853,
                              0.147612855200325), p2 = c(1.51998266661658e-05, 0.000735514148540267,
                                                         0.000257991373422057, 0.00059362196111521, 7.85122021502234e-06,
                                                         8.90287088154453e-09, 1.51982905513589e-05, 1.19610978756787e-05
                              ), value = c(-2.58928450160544, -2.58920096193083, -2.58924722700034,
                                           -2.5892476737702, -2.58928450385012, -2.58928450692501, -2.58928450161932,
                                           -2.58928450363881), fevals = c(111, 108, 80, 89, NA, 27, 83,
                                                                          85), gevals = c(NA, 18, 13, 89, NA, 37, 38, 31), niter = c(NA,
                                                                                                                                     NA, NA, NA, 84, 15, NA, NA), convcode = c(0, 0, 0, 52, 0, 0,
                                                                                                                                                                               0, 2), kkt1 = c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
                                                                                                                                                                                               FALSE), kkt2 = c(FALSE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE,
                                                                                                                                                                                                                FALSE), xtime = c(0.978000000000009, 1.494, 1.176, 3.569, 2.54900000000001,
                                                                                                                                                                                                                                  0.563000000000002, 1.82899999999999, 1.464), opt.method = c("Nelder-Mead",
                                                                                                                                                                                                                                                                                              "BFGS", "CG", "L-BFGS-B", "nlm", "nlminb", "Rcgmin", "Rvmmin"
                                                                                                                                                                                                                                  )), details = structure(list("Nelder-Mead", "BFGS", "CG", "L-BFGS-B",
                                                                                                                                                                                                                                                               "nlm", "nlminb", "Rcgmin", "Rvmmin", c(4.17046472316248e-05,
                                                                                                                                                                                                                                                                                                      19728522582628.7), c(0.0981675402187391, 0.0333978657636779
                                                                                                                                                                                                                                                                                                      ), c(0.0696238321682373, 0.0117550562632123), c(0.0624281834561035,
                                                                                                                                                                                                                                                                                                                                                      0.0270705519194787), c(0.000474638305369863, -104377490736903
                                                                                                                                                                                                                                                                                                                                                      ), c(5.57154022554701e-07, -104378309298301), c(2.23787655119863e-07,
                                                                                                                                                                                                                                                                                                                                                                                                      19728522612933.5), c(-1.93427285571397e-07, -104377061763316
                                                                                                                                                                                                                                                                                                                                                                                                      ), structure(c(67.896894579023, 1098.4126984127, 1098.4126984127,
                                                                                                                                                                                                                                                                                                                                                                                                                     -1555872754338465280), .Dim = c(2L, 2L)), structure(c(67.6797038085671,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           -0.272012526780309, -0.272012526780309, 45.4067879377907), .Dim = c(2L,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               2L)), structure(c(67.7438310873179, -0.0949146936965439,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 -0.0949146936965439, 45.5635820360237), .Dim = c(2L, 2L)),
                                                                                                                                                                                                                                                               structure(c(67.7588908428002, -0.218101496836475, -0.218101496836475,
                                                                                                                                                                                                                                                                           45.6018662218222), .Dim = c(2L, 2L)), structure(c(67.8959452064988,
                                                                                                                                                                                                                                                                                                                             -2446.60317460317, -2446.60317460317, 17970325337720672256
                                                                                                                                                                                                                                                                           ), .Dim = c(2L, 2L)), structure(c(67.8969854769847, -2503.2380952381,
                                                                                                                                                                                                                                                                                                             -2503.2380952381, 18253286006765176832), .Dim = c(2L, 2L)),
                                                                                                                                                                                                                                                               structure(c(67.8969855846905, 1099.61904761905, 1099.61904761905,
                                                                                                                                                                                                                                                                           -1555877462780167680), .Dim = c(2L, 2L)), structure(c(67.896986738054,
                                                                                                                                                                                                                                                                                                                                 -2474.03174603175, -2474.03174603175, 17824655976607471616
                                                                                                                                                                                                                                                                           ), .Dim = c(2L, 2L)), c(67.8968945790238, -1555872754338465280
                                                                                                                                                                                                                                                                           ), c(67.6830253216867, 45.4034664246711), c(67.7442372429971,
                                                                                                                                                                                                                                                                                                                       45.5631758803445), c(67.7610375053407, 45.5997195592818),
                                                                                                                                                                                                                                                               c(17970325337720672256, 67.8959452064985), c(18253286006765176832,
                                                                                                                                                                                                                                                                                                            67.8969854769843), c(67.8969855846913, -1555877462780167680
                                                                                                                                                                                                                                                                                                            ), c(17824655976607471616, 67.8969867380537), "none", "none",
                                                                                                                                                                                                                                                               "none", "none", "none", "none", "none", "none"), .Dim = c(8L,
                                                                                                                                                                                                                                                                                                                         5L), .Dimnames = list(c("Nelder-Mead", "BFGS", "CG", "L-BFGS-B",
                                                                                                                                                                                                                                                                                                                                                 "nlm", "nlminb", "Rcgmin", "Rvmmin"), c("method", "ngatend",
                                                                                                                                                                                                                                                                                                                                                                                         "nhatend", "hev", "message"))), maximize = FALSE, npar = 2L, follow.on = FALSE, row.names = c("Nelder-Mead",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "BFGS", "CG", "L-BFGS-B", "nlm", "nlminb", "Rcgmin", "Rvmmin"
